...
*/
    ...
    delegate void SCPLocationsCompletionBlock([NullAllowed] SCPLocation[] locations, bool hasMore, [NullAllowed] NSError error);
    ...
    // typedef void (^SCPCollectedDataCompletionBlock)(SCPCollectedData * _Nullable, NSError * _Nullable);
    delegate void SCPCollectedDataCompletionBlock ([NullAllowed] SCPCollectedData collectedData, [NullAllowed] NSError error);
	...
	interface SCPCart
	{
		...
		// @property (readonly, assign, nonatomic) NSInteger tax;
		[Export ("tax")]
		nint Tax { get; }
    ...
    interface SCPCartLineItem : INativeObject
	{
		...
		// @property (readonly, assign, nonatomic) NSInteger amount;
		[Export ("amount")]
		nint Amount { get; }
	}
	...
	interface SCPCollectConfiguration : INSCopying
	{
		...
		// @property (readonly, nonatomic, strong) NSString * _Nullable surchargeNotice;
		[NullAllowed, Export ("surchargeNotice", ArgumentSemantic.Strong)]
		string SurchargeNotice { get; }
	}
	...
	interface SCPCollectConfigurationBuilder
	{
		...
		// -(SCPCollectConfigurationBuilder * _Nonnull)setSurchargeNotice:(NSString * _Nullable)surchargeNotice;
		[Export ("setSurchargeNotice:")]
		SCPCollectConfigurationBuilder SetSurchargeNotice ([NullAllowed] string surchargeNotice);
	}

	// @interface SCPCollectedData : NSObject
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface SCPCollectedData
	{
	...
	[BaseType (typeof(NSObject))]
	interface SCPCollectDataConfiguration : INSCopying
	{
		// @property (readonly, assign, nonatomic) SCPCollectDataType collectDataType;
		[Export ("collectDataType", ArgumentSemantic.Assign)]
		SCPCollectDataType CollectDataType { get; }
	}

	// @interface SCPCollectDataConfigurationBuilder : SCPBuilder
	[BaseType (typeof(SCPBuilder<SCPCollectDataConfiguration>))]
	interface SCPCollectDataConfigurationBuilder
	{
		// -(SCPCollectDataConfigurationBuilder * _Nonnull)setCollectDataType:(SCPCollectDataType)collectDataType;
		[Export ("setCollectDataType:")]
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface SCPConfirmConfiguration : INSCopying
	{
		// @property (readonly, nonatomic, strong) NSNumber * _Nullable amountSurcharge;
		[NullAllowed, Export ("amountSurcharge", ArgumentSemantic.Strong)]
		NSNumber AmountSurcharge { get; }
	}

	// @interface SCPConfirmConfigurationBuilder : SCPBuilder
	[BaseType (typeof(SCPBuilder<SCPConfirmConfiguration>))]
	interface SCPConfirmConfigurationBuilder
	{
		// -(SCPConfirmConfigurationBuilder * _Nonnull)setAmountSurcharge:(NSUInteger)amountSurcharge;
		[Export ("setAmountSurcharge:")]
		SCPConfirmConfigurationBuilder SetAmountSurcharge (nuint amountSurcharge);
	}
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface SCPCardPresentParameters : ISCPJSONDecodable, INSCopying
	{
		...
		// @property (readonly, nonatomic) SCPSurcharge * _Nullable surcharge;
		[NullAllowed, Export ("surcharge")]
		SCPSurcharge Surcharge { get; }
	}
	...
	interface SCPCardPresentParametersBuilder
	{
		...
		// -(SCPCardPresentParametersBuilder * _Nonnull)setSurcharge:(SCPSurcharge * _Nullable)surcharge;
		[Export ("setSurcharge:")]
		SCPCardPresentParametersBuilder SetSurcharge ([NullAllowed] SCPSurcharge surcharge);
	}

	// @interface SCPPaymentMethodOptionsParameters : NSObject <SCPJSONDecodable, NSCopying>
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface SCPPaymentMethodOptionsParameters : ISCPJSONDecodable, INSCopying
	{
		// @property (readonly, nonatomic) SCPCardPresentParameters * _Nonnull cardPresentParameters;
		[Export ("cardPresentParameters")]
...
*/[Protocol]
	...
	interface SCPPaymentIntent : ISCPJSONDecodable, INSCopying
	{
		...
		// @property (readonly, nonatomic) SCPPaymentMethodOptionsParameters * _Nullable paymentMethodOptions;
		[NullAllowed, Export ("paymentMethodOptions")]
		SCPPaymentMethodOptionsParameters PaymentMethodOptions { get; }
	...
	interface SCPTerminal
	{
		...
		// -(void)confirmPaymentIntent:(SCPPaymentIntent * _Nonnull)paymentIntent confirmConfig:(SCPConfirmConfiguration * _Nullable)confirmConfig completion:(SCPConfirmPaymentIntentCompletionBlock _Nonnull)completion;
		[Export ("confirmPaymentIntent:confirmConfig:completion:")]
		[Async(ResultTypeName = "PaymentProcessResult")]
		void ConfirmPaymentIntent (SCPPaymentIntent paymentIntent, [NullAllowed] SCPConfirmConfiguration confirmConfig, SCPConfirmPaymentIntentCompletionBlock completion);
		...
		void SetReaderSettings (SCPReaderSettingsParameters @params, SCPReaderSettingsCompletionBlock completion);
		...
		// -(SCPCancelable * _Nullable)collectData:(SCPCollectDataConfiguration * _Nonnull)collectDataConfiguration completion:(SCPCollectedDataCompletionBlock _Nonnull)completion __attribute__((swift_name("collectData(_:completion:)")));
		[Export ("collectData:completion:")]
		[return: NullAllowed]
        [Async(ResultTypeName = "CollectDataResult")]
		SCPCancelable CollectData (SCPCollectDataConfiguration collectDataConfiguration, SCPCollectedDataCompletionBlock completion);
	...
	interface SCPReconnectionDelegate
	{
		...
		void ReaderDidStartReconnect(SCPReader reader, SCPCancelable cancelable);
		...
		void ReaderDidStartReconnectWithReason(SCPReader reader, SCPCancelable cancelable, SCPDisconnectReason disconnectReason);
	}
	...
	*/
	...
	interface SCPListLocationsParameters
	{
		...
		// @property (readonly, copy, nonatomic) NSString * _Nullable endingBefore;
		[NullAllowed, Export ("endingBefore")]
		string EndingBefore { get; }

		// @property (readonly, copy, nonatomic) NSString * _Nullable startingAfter;
		[NullAllowed, Export ("startingAfter")]
		string StartingAfter { get; }
	}
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface SCPSurcharge : ISCPJSONDecodable, INSCopying
	{
		// @property (readonly, nonatomic) NSString * _Nonnull status;
		[Export ("status")]
		string Status { get; }

		// @property (readonly, assign, nonatomic) NSUInteger maximumAmount;
		[Export ("maximumAmount")]
		nuint MaximumAmount { get; }
	}
...
*/
	...
	*/
	...
	interface SCPAppleBuiltInReaderAccountLinkingDelegate
	{
		...
		void AppleBuiltInReaderDidFailToLinkAccountWithError (SCPAppleBuiltInReader reader, NSError error);
	}
	...
	interface SCPAppleBuiltInReaderPrepareDelegate
	{
		...
		void AppleBuiltInReaderDidReportPrepareProgress (SCPAppleBuiltInReader reader, float progress);
		...
		void AppleBuiltInReaderDidFailToPrepareWithError (SCPAppleBuiltInReader reader, NSError error);
	}
	...
	interface SCPAppleBuiltInReaderTransactionDelegate
	{
		...
		void AppleBuiltInReaderDidCollectPaymentCard (SCPAppleBuiltInReader reader, [NullAllowed] string data, [NullAllowed] string generalCardData, string paymentCardId, string merchantReference);
		...
		void AppleBuiltInReaderDidFailToPerformTransaction (SCPAppleBuiltInReader reader, NSError error);
		...
		void AppleBuiltInReaderDidReportTransactionEvent (SCPAppleBuiltInReader reader, SCPAppleBuiltInReaderTransactionEvent @event);
		...
		void AppleBuiltInReaderDidFailToCancelTransaction (SCPAppleBuiltInReader reader, NSError error);
	...
	// @interface StripeTerminal_Swift_766 (NSError)
	[Category]
	[BaseType (typeof(NSError))]
	interface NSError_StripeTerminal_Swift_766
	{
